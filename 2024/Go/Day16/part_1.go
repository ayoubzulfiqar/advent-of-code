...
// func parseGrid(grid []string) (Point, Point, map[string]map[string]int) {
...
// 		// Ensure that each row has the correct length
// 		if len(grid[y]) != width {
...
// func lowestScoreOfReindeer() int {
// 	input := readFile("input.txt")
// 	if input == "" {
// 		panic("No Input")
// 	}
// 	grid := strings.Split(input, "\n")
// 	start, end, forward := parseGrid(grid)
// 	distances := dijkstra(forward, start, false)
// 	return distances[fmt.Sprintf("%d,%d", end.x, end.y)]
// }
